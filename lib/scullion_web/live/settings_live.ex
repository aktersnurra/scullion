    ...
    <.page max_width={:md}>
      <.card padded={false}>
        <header class="px-6 pt-6 pb-3">
          <h1 class="font-semibold text-[var(--text)]" style="font-size: var(--t-h1);">Settings</h1>
        </header>

        <section class="px-6 pt-3 pb-5 border-t border-[color:var(--hairline)]">
          <h2 class="uppercase tracking-wider text-[color:var(--subtle)] mb-3" style="font-size: var(--t-micro); font-weight: 600;">Users</h2>
          <div :if={@current_user} class="flex items-center gap-3">
            ...
            <button type="button" class="inline-flex items-center gap-1.5 text-[color:var(--accent)] hover:underline" style="font-size: var(--t-meta);">
              <.icon name="hero-plus" class="size-4" /> Generate new code
            </button>
          </div>
        </section>

        <section class="px-6 pt-5 pb-5 border-t border-[color:var(--hairline)]">
          <h2 class="uppercase tracking-wider text-[color:var(--subtle)] mb-3" style="font-size: var(--t-micro); font-weight: 600;">Device tokens</h2>
          <div class="flex items-center gap-3">
            <.icon name="hero-device-tablet" class="size-5 text-[color:var(--muted)] shrink-0" />
            <div class="flex-1 min-w-0">
              <p class="font-medium" style="font-size: var(--t-body);">Kitchen kiosk</p>
              <p class="text-[color:var(--accent)]" style="font-size: var(--t-meta);">active</p>
            </div>
            <button type="button" class="text-[color:var(--danger)] hover:underline" style="font-size: var(--t-meta);">Revoke</button>
          </div>
        </section>

        <section class="px-6 pt-5 pb-6 border-t border-[color:var(--hairline)]">
          <h2 class="uppercase tracking-wider text-[color:var(--subtle)] mb-3" style="font-size: var(--t-micro); font-weight: 600;">Jobs</h2>
          <div class="flex flex-wrap gap-2">
            <.button variant={:secondary}>Run deal scrape</.button>
